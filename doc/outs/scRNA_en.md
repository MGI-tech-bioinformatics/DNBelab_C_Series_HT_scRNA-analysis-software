...
<tr>
<td align="center"><strong>🔬 Quality Control</strong></td>
...
<tr>
<td align="center"><strong>🔧 Compatibility</strong></td>
<td>Compatible with mainstream single-cell analysis tools: Scanpy, Seurat, etc.</td>
</tr>
<tr>
<td align="center"><strong>🌐 Transferability</strong></td>
...
<thead>
<tr>
<th width="25%" align="center"><strong>Technical Features</strong></th>
<th width="75%" align="left"><strong>Detailed Description</strong></th>
</tr>
</thead>
<tbody>
<tr>
<td align="center"><strong>🗂️ Compression Efficiency</strong></td>
...
<tr>
<td align="center"><strong>⚡ Access Speed</strong></td>
...
<tr>
<td align="center"><strong>🔄 Sorting Status</strong></td>
...
<tr>
<td align="center"><strong>🏷️ Rich Metadata</strong></td>
...
<thead>
<tr>
<th width="10%" align="center"><strong>Tag</strong></th>
<th width="20%" align="center"><strong>Data Type</strong></th>
...
<td align="center">String</td>
<td align="center">Genomic region type</td>
...
> 💡 **Usage Recommendations**: It is recommended to view each metric in the order presented in the report, paying special attention to warning information and optimization suggestions in the quality control section.
...
**🎯 Core Function**: Cell identification, quality assessment, and sequencing depth statistics, providing key metrics for overall experimental effectiveness

</div>

**📊 Quality Control Reference Standards:**

> **Note**: The following standards are for reference only. Actual quality assessment should consider multiple factors such as tissue type, cell state, and experimental objectives. Significant differences exist between samples, so it is recommended to combine with specific experimental context for judgment.
...
<tr>
<td align="center"><strong>Median UMI per cell</strong></td>
<td align="center">≥ 2,000</td>
<td align="center">800–2,000</td>
<td align="center">< 800</td>
</tr>
<tr>
<td align="center"><strong>Median genes per cell</strong></td>
<td align="center">≥ 1,200</td>
<td align="center">600–1,200</td>
...
<td align="center">< 20% or > 85% (over-sequencing)</td>
</tr>
</tbody>
</table>
...
<td>
Refers to the number of cells identified as real cells (rather than background noise or empty droplets) in the sequencing data.
<div style="padding: 10px; border-left: 4px solid #0ea5e9; margin: 10px 0;">
<strong>🔬 Technical Requirements</strong>
<ul>
<li>📊 <strong>Calculation Process</strong>: The calculation process involves merging cell barcodes from the same droplet and then predicting real cells based on the empty droplet model (EmptyDrops). This algorithm uses statistical methods to analyze the UMI count distribution of cell barcodes, distinguishing real cells from empty droplets or background noise</li>
<li>⚠️ <strong>Abnormal Causes</strong>: Values higher or lower than expected may indicate inaccurate cell counting, cell lysis, or failure in the droplet generation process</li>
</ul>
</div>
</td>
</tr>
...
<ul>
<li>🎯 <strong>Recommended Threshold</strong>: A high proportion indicates accurate cell identification, less sample contamination, and good library construction quality</li>
...
<tr>
<td align="center">
<strong>Corrected barcodes</strong>
</td>
<td>
...
<ul>
<li>🎯 <strong>Recommended Standard</strong>: >75%</li>
...
<ul>
<li>🎯 <strong>Recommended Standard</strong>: >80%</li>
...
<thead>
<tr>
<th width="30%" align="center"><strong>Pattern Characteristics</strong></th>
<th width="70%" align="left"><strong>Quality Interpretation</strong></th>
</tr>
</thead>
<tbody>
<tr>
<td align="center"><strong>✅ Ideal Pattern</strong></td>
...
<tr>
<td align="center"><strong>⚠️ Abnormal Pattern</strong></td>
...
<thead>
<tr>
<th width="25%" align="center"><strong>Metric</strong></th>
<th width="35%" align="center"><strong>Common Range (Reference Value)</strong></th>
<th width="40%" align="left"><strong>Abnormal Interpretation (Possible Causes)</strong></th>
</tr>
</thead>
<tbody>
<tr>
<td align="center"><strong>Gene Count</strong></td>
<td align="center">Most cells approximately 500–6,000 genes</td>
<td align="left"><500: Low-quality cells or RNA degradation; >6,000–8,000: Possibly doublets/multiplets</td>
</tr>
<tr>
<td align="center"><strong>UMI Count</strong></td>
<td align="center">Most cells approximately 1,000–50,000</td>
<td align="left">Too low: Empty droplets or low RNA content; Too high: Doublets or library amplification bias</td>
</tr>
<tr>
<td align="center"><strong>Mitochondrial Proportion</strong></td>
<td align="center">Generally <10–20%</td>
...
<thead>
<tr>
<th width="30%" align="center"><strong>Chart Composition</strong></th>
<th width="70%" align="left"><strong>Technical Details and Biological Significance</strong></th>
</tr>
</thead>
<tbody>
<tr>
<td align="center"><strong>🎨 Left Clustering Chart</strong></td>
...
<tr>
<td align="center"><strong>📊 Right UMI Chart</strong></td>
...
<thead>
<tr>
<th width="20%" align="center"><strong>Statistical Metric</strong></th>
...
<thead>
<tr>
<th width="25%" align="center"><strong>Technical Specifications</strong></th>
<th width="75%" align="left"><strong>Detailed Description</strong></th>
</tr>
</thead>
<tbody>
<tr>
<td align="center"><strong>📚 Reference Databases</strong></td>
...
<thead>
<tr>
<th width="30%" align="center"><strong>Chart Type</strong></th>
<th width="70%" align="left"><strong>Technical Principles and Interpretation Guidance</strong></th>
</tr>
</thead>
<tbody>
<tr>
<td align="center"><strong>📊 Left Saturation Curve</strong></td>
...
<tr>
<td align="center"><strong>📈 Right Gene Count Curve</strong></td>
