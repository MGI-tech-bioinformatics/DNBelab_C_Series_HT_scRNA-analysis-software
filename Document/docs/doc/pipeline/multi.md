...
<div style="background-color: #e7f3fe; border-left: 6px solid #2196F3; padding: 15px; margin: 1.5em 0; border-radius: 4px;" markdown="block">
 <strong>详细配置说明</strong>：请参考 <a href="../parameter/multi.html">多组学参数文档</a> 了解完整的 CSV 配置规范和参数映射关系。
</div>
...
<div style="background-color: #e7f3fe; border-left: 6px solid #2196F3; padding: 15px; margin: 1.5em 0; border-radius: 4px;" markdown="block">
 <strong>详细输出说明</strong>：请参考 <a href="../outs/multi.html">多组学输出文档</a> 了解组合报告的详细解读方法。
</div>
