...
# 4.csv to data-table
###########################''')
if os.path.exists(path+'/07.report/10.marker.csv'): 
    df1= pd.read_csv(open(path+'/07.report/10.marker.csv'),encoding="utf-8",dtype=str,)
    fw = open(path+'/07.report/table/marker-table.txt','w')
